...
Contiene información de clientes: edad, ciudad, fecha de registro, plan contratado.
	...
	- Columna city tiene 11% de nulos, se revisa la relación entre 'city' y 'user_id'.  para el cual ******
...
Contiene información de los clientes: edad, ciudad, fecha de registro, plan contratado.
	- El tipo de dato de la columna 'date' se debía cambiar a tipo fecha. Aquí solo se encuentran datos del año 2024. Esta columna tiene un 1% de nulos, lo cual podría imputar si encuentro un patrón o dejarlo como nulo
 ...
 - **¿Qué segmentos de clientes identificaste y cómo se comportan según su edad y nivel de uso?**
   ...
   - Por ultimo, los usuarios envian entre 3 a 7 mensaje de texto. En el caso del Plan Premium aproximadamente 200 usuarios envian 5 mensajes y en el plan Basico 4000 usuarios envian 5 mensajes.

- **¿Qué patrones de uso extremo (outliers) encontraste y qué implican para el negocio?**
  
Se encuentran pocos outliers a revisar. En el caso de Cantidad de mensajes  van entre 12 a 17 mensajes y cantidad de llamadas de 11 a 15 llamdas, estos son pocos y son posibles y no parecen un error, es decir que son manejables.  Por el otro lado, la cantidad de minutos si tiene  outliers que van desde los 60 a 155minutos de elongacion de la llamda, lo cual es muy poco probable,
